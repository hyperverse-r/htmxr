...
# Shared data function used by both endpoints
  ...
  hx_page(
    ...
    tags$div(
      ...
      tags$p(
        ...
        "The same data is served as JSON (",
        tags$code("GET /api/rows"),
        ") and as HTML for htmx (",
        tags$code("GET /rows"),
        ")."
      ),
      tags$div(
...
# ── HTML fragment endpoint (for htmx) ─────────────────────────────────────────
#* @get /rows
#* @query cut:string("all")
#* @parser none
#* @serializer none
